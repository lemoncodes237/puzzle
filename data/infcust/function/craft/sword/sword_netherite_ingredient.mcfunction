...
execute if items entity @s container.0 ghast_tear run function infcust:craft/ingredients/ghast_tear
...
execute if items entity @s container.0 heavy_core run function infcust:craft/ingredients/heavy_core
execute if items entity @s container.0 creeper_head run function infcust:craft/ingredients/creeper_head
