...
data modify storage infcust:craft max set value 120
...
data modify storage infcust:craft max set value 35
data modify storage infcust:craft operation set value "remove"
...
scoreboard players set #divide inf-id 7
