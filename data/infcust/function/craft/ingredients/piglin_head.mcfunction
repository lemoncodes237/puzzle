...
data modify storage infcust:craft stat set value "inf-fireprot"
data modify storage infcust:craft min set value 3
data modify storage infcust:craft max set value 6
data modify storage infcust:craft operation set value "remove"
...
scoreboard players set #inf-ember inf-id 1